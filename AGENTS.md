...
## UI Changes
- Check [src/gtk-ui.glade](src/gtk-ui.glade) for XML definitions or [src/main.rs](src/main.rs) for programmatic changes.
...
- Styling: [src/github-markdown.css](src/github-markdown.css) and [src/highlight.css](src/highlight.css) control the look of the preview.

## Requirements for Environment
- System libraries: `libgtk-3-dev`, `libgtksourceview-3.0-dev`, `libwebkit2gtk-4.0-dev`.
